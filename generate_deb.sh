...
CURRENT_PATH=../../../
cd modules/nubo_ear/nubo-ear-detector/ ;     sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
cd modules/nubo_eye/nubo-eye-detector/ ;     sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
cd modules/nubo_face/nubo-face-detector/ ;   sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
cd modules/nubo_mouth/nubo-mouth-detector/ ; sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
cd modules/nubo_nose/nubo-nose-detector/ ;   sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
cd modules/nubo_tracker/nubo-tracker/ ;      sh compile_filter.sh; cd $CURRENT_PATH #sh compile_filter.sh js; cd $CURRENT_PATH
